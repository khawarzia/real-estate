...
$(document).ready(function(){
        ...
        behaviourSlider.noUiSlider.on('update', function(values, handle) {
            document.getElementById('slider-range-value1').innerHTML = Math.round(values[0]) +'<sup>2</sup>';
            document.getElementById('slider-range-value2').innerHTML = Math.round(values[1]) +'<sup>2</sup>';
